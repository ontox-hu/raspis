...
## Introduction
This workflow describes how to retrieve information (here PubChem cid and synonyms) for a given compound inchi, using the NCBI Entrez PUG-REST API. 
...
#usethis::use_data(merged_source_cid_synonyms)
